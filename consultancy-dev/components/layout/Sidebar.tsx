...
const NAV_ITEMS = [
  ...
  { label: 'Doc Expiry', href: '/app/documents/expiry', icon: AlertCircle, roles: ['ALL'] },
  { label: 'Doc Transfer', href: '/app/document-transfer', icon: FileOutput, roles: ['ALL'] },
  { label: 'Doc Tracking', href: '/app/document-tracking', icon: Activity, roles: ['ALL'] },
